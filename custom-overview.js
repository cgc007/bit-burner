...
export async function main(ns) {
	...
	while (true) {
		try {
			...
			values.push(ns.nFormat(ns.getServerUsedRam("home") * 1e9, "0.0b") + " / " + ns.nFormat(ns.getServerMaxRam("home") * 1e9, "0.0b"));

			headers.push("Home Ram Use");
			values.push(((ns.getServerUsedRam("home") / ns.getServerMaxRam("home")) * 100).toFixed(1) + "%");
